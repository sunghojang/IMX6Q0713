/* linux/include/media/mt9p111_platform.h
 *
 * Copyright (c) 2010 Samsung Electronics Co., Ltd.
 *		http://www.samsung.com/
 *
 * Driver for MT9P111 (UXGA camera) from Samsung Electronics
...
#define MT9P111_STREAMOFF_DELAY    120



enum {
	MT9P111_FLASH_MODE_NORMAL,
	MT9P111_FLASH_MODE_MOVIE,
	MT9P111_FLASH_MODE_MAX,
};
...
struct mt9p111_mbus_platform_data {
	int id;
