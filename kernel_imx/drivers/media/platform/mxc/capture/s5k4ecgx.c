...
static const struct s5k4ecgx_framesize s5k4ecgx_preview_frmsizes[] = {
	...
	{ S5K4ECGX_PREVIEW_1MP,		1280, 960 },
	{ S5K4ECGX_PREVIEW_2MP,		1600, 1200 },
	{ S5K4ECGX_PREVIEW_3MP,		2048, 1536 },
	{ S5K4ECGX_PREVIEW_5MP,		2560, 1920 },
};
...
static const struct s5k4ecgx_regs reg_datas = {
	...
	.preview_size = {
		...
		S5K4ECGX_REGSET(S5K4ECGX_PREVIEW_1MP,		s5k4ecgx_1MP_Preview),
		S5K4ECGX_REGSET(S5K4ECGX_PREVIEW_2MP,		s5k4ecgx_2MP_Preview),
		S5K4ECGX_REGSET(S5K4ECGX_PREVIEW_3MP,		s5k4ecgx_3MP_Preview),
		S5K4ECGX_REGSET(S5K4ECGX_PREVIEW_5MP,		s5k4ecgx_5MP_Preview),
		S5K4ECGX_REGSET(S5K4ECGX_PREVIEW_5MP_PLUS,	s5k4ecgx_5MP_Plus_Preview),
	},
	.scene_mode = {
...
/*! by crazyboy 20151013 by treego
 *  For FXL6408 IC *
 *  CS-CAM5M-PRST Board */
	...
	for (i = 0; i < size; i++) {
		...
		case 0x0F12:
			...
			if (next_subaddr != 0x0F12) {
				...
				cam_dbg("s5k4ecgx_sensor_burst_write, idx = %d\n", idx); 
				idx = 0;
			}
			break;
...
/*! by crazyboy 20151013 by treego
 *  fxl6408 initialize and 2V8EN, MIPI RSTN*
 *  */
